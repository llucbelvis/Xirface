...
namespace Xirface
{
    public class Entity
    {
        ...
        public Shader<VertexPositionColor> Shader;
        

        public Entity(Shader<VertexPositionColor> shader, Vector2 position, Vector2 origin, float depth)
        {
            this.Origin = origin;
        ...
        public virtual void Draw(Vulkan graphics, CommandBuffer cmd, Camera Camera, Shader<VertexPositionColor> shader)
        {
