...
namespace Xirface
{
    public class String : Entity
    {
        ...
        public String(Shader shader, Vector2 position, Vector2 origin, Vector2 size, float depth, Color color, Font font, string content, float fontSize, Alignment align)
