...
namespace Xirface
{
    ...
    public class Glyph
    {
        ...
        public List<VertexFont> vertices = new();
        ...
        bool IsClockwise(Contour contour)
        {
            float sum = 0;
            for (int i = 0; i < contour.glyphPoints.Count; i++)
            {
        ...
        public Glyph Load()
        {
            ...
            foreach (Contour contour in Contours)
            {
                for (int i = 0; i < contour.triangles.Count; i++)
                {
                    ...
                    vertices.Add(new VertexFont(new Vector3(points[0], 0), Color.Black(), new Vector2(0, 0),  1, side ? (short)1 : (short)-1));
                    vertices.Add(new VertexFont(new Vector3(points[1], 0), Color.Black(), new Vector2(0.5f, 0),  1, side ? (short)1 : (short)-1));
                    vertices.Add(new VertexFont(new Vector3(points[2], 0), Color.Black(), new Vector2(1, 1),  1, side ? (short)1 : (short)-1));
            ...
            foreach (Contour contour in Contours)
            {
                ...
                {
                    vertices.Add(new VertexFont(new Vector3(triangles[i * 3 + 0], 0), Color.Black(), Vector2.Zero, -1, 1));
                    vertices.Add(new VertexFont(new Vector3(triangles[i * 3 + 1], 0), Color.Black(),Vector2.Zero, -1, 1));
                    vertices.Add(new VertexFont(new Vector3(triangles[i * 3 + 2], 0), Color.Black(),Vector2.Zero, -1, 1));
